...
Source2: http://khapplications.darktech.org/pics/background4.jpg
Source3: %{theme_name}-index.theme
URL: http://khapplications.darktech.org/pages/themes/fear.html
BuildArch: noarch

%description
This theme and icon set is based on the fear theme for OSX and the murder mystery
icon set. Thanks to Joe Loy at http://www.fearutopia.com for permmision to use
