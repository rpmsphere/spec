...
./configure \\\
    ...
    --extra-cflags="%{?nvenc_cflags} %{?cuda_cflags} %{?libnpp_cflags} -fPIC" \\\
...
sed -i 's|CCFLAGS     = |CCFLAGS     = -fPIC |' common.mak
...
%make_build V=1 CFLAGS+="-fPIC -I/usr/include/freetype2 -I/usr/include/fribidi -I/usr/include/opus -I/usr/include/schroedinger-1.0"
