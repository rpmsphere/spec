...
sed -i '/case CLASS_MASS_STORAGE:/d' channels/urbdrc/client/libusb/libusb_udevice.c
...
%changelog
* Fri Mar 06 2015 David Woodhouse <dwmw2@infradead.org> - 1:1.2.0-0.6.beta.1.2
- Backport upstream patch to avoid TCP_KEEPIDLE failure being fatal

* Fri Jan 23 2015 Orion Poplawski <orion@cora.nwra.com> - 1:1.2.0-0.6.beta.1.1
