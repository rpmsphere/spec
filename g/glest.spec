...
mkdir -p %buildroot{%_gamesdatadir/%name,%_gamesbindir,%_docdir/%name-%version,%{_datadir}/icons/hicolor/32x32/apps,%_desktopdir}
...
install -pm 644 %SOURCE4 %buildroot%{_datadir}/icons/hicolor/32x32/apps/%name.png
