...
Requires:       libGLEW1 = %{version}-%{release}
Requires:       libGLEWmx1 = %{version}-%{release}
...
%description -n libGLEW1
libGLEW

%package -n libGLEWmx1
Summary:        libGLEWmx1
Group:          System Environment/Libraries

%description -n libGLEWmx1
libGLEWmx
...
mv %{buildroot}%{_bindir}/glewinfo %{buildroot}%{_bindir}/glewinfo1
mv %{buildroot}%{_bindir}/visualinfo %{buildroot}%{_bindir}/visualinfo1


%post -n libGLEW1 -p /sbin/ldconfig

%postun -n libGLEW1 -p /sbin/ldconfig

%post -n libGLEWmx1 -p /sbin/ldconfig

%postun -n libGLEWmx1 -p /sbin/ldconfig
