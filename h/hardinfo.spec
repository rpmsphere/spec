...
#Source0:  https://download.berlios.de/hardinfo/%{name}-%{version}.tar.bz2
...
%{_datadir}/locale/*/LC_MESSAGES/hardinfo.mo
%{_mandir}/man1/hardinfo.1*
   
%changelog
* Sun May 21 2023 Wei-Lun Chao <bluebat@member.fsf.org> - 0.6-alpha
- Rebuilt for Fedora
