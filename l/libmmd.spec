...
Source0: http://frostworx.de/files/%{name}-%{version}.tar.gz
URL: http://www.frostworx.de/?p=43
...
The original sourcecode is part of the windows program MMD_Desktop (v0.4.9): http://r13n.spaces.live.com
which in turn took its sources from ARTK_MMD (v0.7), which can be found under http://ppyy.hp.infoseek.co.jp/artk_mmd.html
