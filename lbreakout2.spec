# $Id: lbreakout2.spec 4704 2006-08-29 08:23:03Z thias $
# Authority: matthias
...
Source: http://dl.sf.net/lgames/%{name}-%{version}%{?prever}-7.tar.gz
#Source1: %{name}-%{version}.zh_TW.po
BuildRequires: SDL-devel, SDL_mixer-devel, zlib-devel, libpng12-devel
...
%prep
%setup -q -n %{name}-%{version}%{?prever}-7
#%{__sed} -i 's/fr/fr zh_TW/' po/LINGUAS
#%{__cp} %{SOURCE1} po/zh_TW.po
#msgfmt po/zh_TW.po -o po/zh_TW.gmo
sed -i 's|png\.h|libpng12/png.h|' gui/stk.c
