...
Source0: http://snapshots.madwifi-project.org/%{kmod_name}-%{version}-current.tar.gz
Patch0: %{name}-dont_strip_binaries.diff
...
BuildRequires: gcc, kernel-devel
Requires: kernel = %(basename %{kver} .i686.PAE)
License: GPL/BSD
...
%prep
%setup -q -n %{kmod_name}-%{version}-r4133-20100922
##%patch0 -p0
