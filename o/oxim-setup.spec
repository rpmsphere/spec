...
%build
echo $QTDIR
%configure --enable-static=no --enable-setup-qt3=yes --enable-setup-qt4=yes --enable-setup-gambas=yes --enable-qt-immodule=yes
...
* Wed Mar 01 2011 Wind Win <yc.yan@ossii.com.tw> 1.4.5-1
