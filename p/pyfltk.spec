...
%build
CPPFLAGS="-DFL_INTERNALS %optflags -Wno-format-security" python2 setup.py build

%install
rm -rf $RPM_BUILD_ROOT
python2 setup.py install --root=$RPM_BUILD_ROOT
rm -rf $RPM_BUILD_ROOT%{python2_sitearch}/fltk/docs
rm -rf $RPM_BUILD_ROOT%{python2_sitearch}/fltk/test

%files
%doc CHANGES COPYING README TODO
%{python2_sitearch}/fltk
%{python2_sitearch}/*info

%clean
rm -rf $RPM_BUILD_ROOT

%changelog
* Mon Apr 02 2012 Wei-Lun Chao <bluebat@member.fsf.org> - 1.3.0
- Rebuild for Fedora
