...
License: PD
URL: https://sourceforge.net/projects/pyurlsnooper/
Source0: https://sourceforge.net/projects/pyurlsnooper/files/%{name}_v%{version}.tar.gz
Requires: pcapy, python-impacket, pygtk2
BuildArch: noarch

%description
This is a OS independent equivalent of URL Snooper from https://www.donationcoder.com/
(similar to https://sourceforge.net/projects/mediasniffer/). Can be used in combination
with RTMPDump (https://rtmpdump.mplayerhq.hu/) in order to capture streams.
