...
Source: https://download.sourceforge.net/project/%{name}/%{version}/%{name}-src-%{version}.tar.gz
#Requires: efibootmgr
...
%build
make gnuefi EFICRT0=%{_libdir}/gnuefi
make fs_gnuefi EFICRT0=%{_libdir}/gnuefi
