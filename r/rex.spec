...
Summary: A tool to ease the execution of commands on multiple remote servers
Name: rex
Version: 1.3.2
Release: 4.1
License: Apache 2.0
Group: Utilities/System
Source: http://search.cpan.org/CPAN/authors/id/J/JF/JFRIED/Rex-%{version}.tar.gz
URL: http://rex.linux-files.org/
