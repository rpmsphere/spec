...
URL:            https://www.slackware.com/config/packages.php
Group:          Productivity/Archiving/Compression
Source0:        https://gentoo.osuosl.org/distfiles/%{name}-%{version}.tar.lzma
Source1:        rpm2targz.1
Source2:        rpmunpack.1
# PATCH-FIX-UPSTREAM rpm2targz-lzma.patch https://bugs.gentoo.org/show_bug.cgi?id=321439 -- unpack lzma compressed rpms
