...
%if %{fedora}<24
sed -i 's|freetype/fterrdef.h|freetype2/fterrdef.h|' appFrame/appFontConfig.c
%endif
...
for N in 16 24 32 48 64; do
  install -D $N.png %buildroot/%_datadir/icons/hicolor/${N}x${N}/apps/Ted.png
done
...
%_datadir/icons/hicolor/*/apps/Ted.png
%_mandir/man1/*
