...
Source: 	%{name}.zip
BuildArch:	noarch
Requires:	tegaki, python-penpower
...
cp tegakipenpower.py %{buildroot}%{python_sitelib}/tegaki/engines
mkdir -p %{buildroot}%{_datadir}/tegaki/models/penpower
cp handwriting-penpower-zh_TW.meta %{buildroot}%{_datadir}/tegaki/models/penpower
