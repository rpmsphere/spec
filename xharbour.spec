...
%define hb_cflag export C_USR="-O3 -DADS_REQUIRE_VERSION=6 -DHB_GPM_NOICE_DISABLE -DADS_LIB_VERSION=810 "
...
BuildRequires: bison gcc binutils ncurses-devel %{!?_without_gpm: gpm-devel}
BuildRequires: slang-devel libX11-devel unixODBC-devel
...
sed -i 's|extern int yyparse|int yyparse|' source/macro/macro.y
